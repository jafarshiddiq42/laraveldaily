            ...
            <table class="table table-striped">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><?php echo e($item->jurusans->jurusan); ?></td>
                        <td><?php echo e($item->jk); ?></td>
                        <td>
                            <a href="/mahasiswa/edit/<?php echo e($item->id); ?>" class="btn btn-success btn-sm">edit</a>
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="modal-body">
          apakah data dengan nim <?php echo e($item->nim); ?> ingin dihapus ?
        </div>
        <div class="modal-footer">
          <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">tutup</button>
          <form method="POST" action="/mahasiswa/<?php echo e($item->id); ?>">
            <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /opt/lampp/htdocs/laravel-is57/resources/views/page/mahasiswa/index.blade.php ENDPATH**/ ?>